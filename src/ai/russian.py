...
RUSSIAN_RULES = (
    ...
    "БУКВЫ, КОТОРЫХ В РУССКОМ НЕТ: Ҷ/ҷ→ДЖ/дж (Ҷамшед→Джамшед, "
    "Тоҷикистон→Таджикистан), Ҳ→Х, Қ→К, Ғ→Г, Ӣ→И, Ӯ→У, Ө→О, Ү→У, Ң→Н, "
    "І→И, Ї→И, Є→Е, Ґ→Г.\n"
...
RUSSIAN_SHORT = (
    ...
    "E в начале имени→Э; Ҷ→ДЖ, Ҳ→Х, Қ→К, Ғ→Г, Ӣ→И, Ӯ→У. Области — "
    "прилагательными (СУРХАНДАРЬИНСКАЯ ОБЛАСТЬ). Серии, номера, ИНН и VIN "
    "копируй символ в символ и НЕ переводи.\n"
)
